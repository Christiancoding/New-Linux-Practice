...
class LinuxPlusStudyWeb:
    ...
    def setup_routes(self):
        ...
        async def api_status():
            """
            This is now an async route.
            We've added a small `asyncio.sleep` to demonstrate non-blocking behavior.
            """
            try:
                # Simulate a small non-blocking I/O delay
    ...
    def run_flask_app(self):
        """
        MODIFIED: Run the Flask app using Uvicorn instead of the default server.
        Uvicorn will automatically wrap the WSGI Flask app to handle async routes.
        """
